    ...
    public function execute(SalesOrder $order, array $data): SalesReturn
    {
        return DB::transaction(function () use ($order, $data): SalesReturn {
            ...
            $this->postJournalEntry->execute(
                ...
                [
                    ['account_code' => '4030', 'debit_minor' => $refundMinor, 'party_type' => 'customer', 'party_id' => $order->customer_id],
                    ['account_code' => '1100', 'credit_minor' => $refundMinor, 'party_type' => 'customer', 'party_id' => $order->customer_id],
                    ['account_code' => '1200', 'debit_minor' => $returnedCostMinor],
                    ['account_code' => '5000', 'credit_minor' => $returnedCostMinor],
                ],
                'sales_return',
                $salesReturn->id,
                'approved',
