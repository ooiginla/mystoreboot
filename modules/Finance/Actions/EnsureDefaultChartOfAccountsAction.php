...
final class EnsureDefaultChartOfAccountsAction
{
    ...
    private function defaults(): array
    {
        return [
            ...
            '1220' => $this->account('Vendor Advances', 'asset', 'Current Assets', 'Payments made to suppliers before the related goods or services are received.', 'debit'),
            ...
            '2310' => $this->account('Customer Deposits (Unearned Revenue)', 'liability', 'Current Liabilities', 'Payments received against pending customer and online orders before the sale is completed and revenue is earned.', 'credit'),
            ...
            '3400' => $this->account('Opening Balance Equity', 'equity', 'Equity', 'Temporary offset for opening balances imported when an existing business starts using Storeboot.', 'credit'),
