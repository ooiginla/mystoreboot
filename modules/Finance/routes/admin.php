...
Route::get('/journals/download', [FinanceReportController::class, 'downloadJournalEntries'])->name('journals.download');
...
Route::post('/bank-movements', [FinanceReportController::class, 'storeBankMovement'])->name('bank-movements.store');
