...
final class RoutePermissionMap
{
    ...
    public static function map(): array
    {
        return [
            ...
            'admin.business.organizations.activate' => 'business.settings.manage',
            'admin.business.organizations.destroy' => 'business.settings.manage',
            ...
            'admin.catalog.categories.update' => 'catalog.update',
            'admin.catalog.categories.destroy' => 'catalog.delete',
            'admin.catalog.tags.store' => 'catalog.update',
            'admin.catalog.tags.update' => 'catalog.update',
            'admin.catalog.tags.destroy' => 'catalog.delete',
            'admin.catalog.badges.store' => 'catalog.update',
            'admin.catalog.badges.update' => 'catalog.update',
            'admin.catalog.badges.destroy' => 'catalog.delete',
            ...
            // Reseller storefront
            'admin.reseller.index' => ['catalog.view', 'storefront.manage'],
            'admin.reseller.suppliers.index' => 'catalog.view',
            'admin.reseller.products.index' => 'catalog.view',
            'admin.reseller.orders.index' => 'sales.view',
            'admin.reseller.payments.index' => 'sales.view',
            'admin.reseller.settings.index' => 'storefront.manage',
            'admin.reseller.mode.update' => 'storefront.manage',
            'admin.reseller.settings.update' => 'storefront.manage',
            'admin.reseller.suppliers.store' => 'catalog.update',
            'admin.reseller.suppliers.update' => 'catalog.update',
            'admin.reseller.suppliers.destroy' => 'catalog.delete',
            'admin.reseller.suppliers.scan.schedule' => 'catalog.update',
            'admin.reseller.suppliers.scan' => 'catalog.update',
            'admin.reseller.products.update' => 'catalog.update',
            'admin.reseller.orders.show' => 'sales.view',
            'admin.reseller.orders.payment-status.update' => 'sales.update',
            'admin.reseller.orders.items.update' => 'sales.update',
            ...
            'admin.inventory.production.start' => 'inventory.manage',
            'admin.inventory.production.runs.complete' => 'inventory.manage',
            'admin.inventory.production.runs.cancel' => 'inventory.manage',
